...
(defun at-most-one-color (n c k)(
  if (= c k)
    nil
    (append (gen-pairs n (node2var n c k) (+ c 1) k) (at-most-one-color n (+ c 1) k))
 ))

 (defun gen-pairs (n stVarIndex cur k) (
   if (> cur k)
    nil
    (cons (append (list (* stVarIndex -1)) (list (* (node2var n cur k) -1))) (gen-pairs n stVarIndex (+ cur 1) k))
 ))
...
(defun generate-edge-clauses (e k) (
  _generate-edge-clauses e 1 k
))

(defun _generate-edge-clauses (e cur k) (
  if (> cur k)
    nil
